...
docpath = "./data/BOI.pdf"
model = "llama3.2:1b"

if docpath:
    loader = UnstructuredPDFLoader(file_path=docpath)
    data = loader.load()
    print("done loading ...")
else:
...
### visual of above code until here
...
# https://chatgpt.com/share/6a9151ce-0d80-83ee-9e48-1da251b2456e
